...
download aplikasi termux di playstore atau <a href="https://f-droid.org/en/packages/com.termux/">klik disini</a> lalu buka aplikasinya ketikan perintah dibawah ini.
    ...
    $ rm -rf XyraInsta
    $ git clone https://github.com/ZuraKanagami/BRUTE-FACEBOOK
    $ cd BRUTE-FACEBOOK
    $ python main.py
...
sekarang karena script sudah ```diinstall``` tinggal kita jalankan, ketikan perintah dibawah ini
    ...
    $ cd $HOME/BRUTE-FACEBOOK
    $ git pull
    $ python main.py


- Notice me: ```Requests Bikin Tools Boleh``` <a href="https://wa.me/+6281221523195">Klik disini</a>
...
- Notice me: ```Hasil crack publik banyak atau sedikit nya tergantung target yang di dapatkan.```
...
<h5 align="left">Thanks for <a href="https://github.com/Xyaa-Code">Xyaa-Code</a>
